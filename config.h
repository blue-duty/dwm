...
static const char *tags[] = { 
    "", // tag:0  key:1  desc:terminal
    "", // tag:1  key:2  desc:firefox
    "", // tag:2  key:3  desc:
    "󰕧", // tag:3  key:4  desc:
    "", // tag:4  key:c  desc:chrome
    "", // tag:5  key:5  desc:
    "ﬄ", // tag:6  key:6  desc:
    "﬐", // tag:7  key:7  desc:code
    "", // tag:8  key:8  desc:goland
};
...
static Key keys[] = {
    ...
    /* { MODKEY,              XK_s,      togglescratch, SHCMD("zsh -t scratchpad -c float") },                       super s          | 打开scratch终端        */
    { MODKEY,              XK_Return, spawn, SHCMD("alacritty") },                                                     /* super enter      | 打开st终端             */
    /* { MODKEY,              XK_minus,  spawn, SHCMD("xfce4-terminal -c FG") },                                               super +          | 打开全局st终端         */
    ...
    { MODKEY|ShiftMask,    XK_l,      spawn, {.v = slockcmd } },                                                /* super shift l    | 锁定屏幕               */
    ...
    TAGKEYS(XK_3, 2, 0)
    TAGKEYS(XK_4, 3, 0)
    TAGKEYS(XK_c, 4, "google-chrome-stable --proxy-server=127.0.0.1:7890")
    TAGKEYS(XK_5, 5, 0)
    TAGKEYS(XK_6, 6, 0)
    TAGKEYS(XK_7, 7, "code")
    TAGKEYS(XK_8, 8, "goland")
};
