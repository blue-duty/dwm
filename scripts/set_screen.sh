...
two() {
    ...
    xrandr --auto --output $OUTPORT_CONNECTED --pos 0x0 --mode 2560x1440 --rate 60 --scale 1x1 --primary \
           --output $INNER_PORT --mode 1920x1080 --rate 60 --scale 1x1 --left-of $OUTPORT_CONNECTED \
           --output $OUTPORT_DISCONNECTED --off
    # xrandr --output $OUTPORT_CONNECTED --mode 1920x1080 --pos 1920x320 --scale 1x1 --primary \
    #        --output $INNER_PORT --mode 1920x1080 --pos 1920x320 --scale 1x1 \
    #        --output $OUTPORT_DISCONNECTED --off
